...
@section('description','لیست شهرها')
@section('keywords','لیست شهرها')
                            ...
                            <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3">
                                        <form action="{{ route('city.index') }}" role="form">
                                    ...
                                    <div class="col-xs-12 col-sm-3">
                                        <a class="btn btn-sm btn-primary btn-xs-block m-b-10" href="{{ route('city.create') }}">افزودن</a>
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach($cities as $city)
                                                <tr>
                                                    <td>{{ $loop->index+1 }}</td>
                                                    <td>{{ $city->name }}</td>
                                                    <td>{{ Date::make($city->created_at)->toJalali()->format('Y/m/d') }}</td>
                                                    <td>
                                                        @can('delete',$city)
                                                        ...
                                                        @endcan
                                                        @can('update',$city)
                                                            <a class="btn btn-sm btn-primary" href="{{ route('city.edit',$city) }}">
                                                                <i class="ti-pencil"></i>
                                                            </a>
                                                        @endcan
                                                        @can('delete',$city)
