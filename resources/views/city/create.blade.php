...
@section('title','- ثبت شهر جدید')
@section('description','ثبت شهر جدید')
@section('keywords','ثبت شهر جدید')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box clearfix">
                                <h5 class="card-header m-b-20 b-0">افزودن شهر</h5>
                                @include('partial.flashMessage')
                                <form action="{{ route('city.store') }}" method="POST" role="form" class="form-horizontal">
                                    {{ csrf_field() }}
                                    <div class="row">
