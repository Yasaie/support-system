...
@section('title',' - ایجاد اعلامیه جدید')
@section('description','ایجاد اعلامیه جدید')
@section('keywords','ایجاد اعلامیه جدید')
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h5 class="card-header m-b-20 b-0">ایجاد اعلامیه</h5>
                                @include('partial.flashMessage')
                                <form method="POST" class="form-horizontal" action="{{ route('notification.store') }}" role="form">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12">
                                            <div class="form-group {{ $errors->has('subject') ? ' has-error' : '' }}">
                                                <label for="subject">موضوع</label>
                                                <input name="subject" type="text" id="subject" value="{{ old('subject') }}" class="form-control" placeholder="مثال: ارائه راهکار" required>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12">
                                            <div class="form-group {{ $errors->has('recipients') ? ' has-error' : '' }}">
                                                ...
                                                <select name="recipients[]" id="recipients" class="select2 select2-multiple" multiple data-placeholder="گیرنده"></select>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group {{ $errors->has('message') ? ' has-error' : '' }}">
                                                ...
                                                <textarea name="message" class="use-rich-editor" id="message" maxlength="250" rows="6" data-placeholder="محتوای خبر را وارد کنید...">{{ old('message') }}</textarea>
                                            </div>
