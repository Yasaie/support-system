                            ...
                            <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3">
                                        <form action="{{ route('notification.garbage') }}" method="GET" role="form">
                                        ...
                                        <tbody>
                                            @foreach($notifications as $notification)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @can('permanentDelete',$notification)
                                                            <form action="{{ route('notification.permanentDestroy',$notification) }}" method="POST">
                                                                {{ csrf_field() }}
                                                                {{ method_field('DELETE') }}
                                                        @endcan
                                                        @can('recycle',$notification)
                                                            <a class="btn btn-sm btn-primary" href="{{ route('notification.recycle',$notification) }}">
                                                                بازیابی
                                                            </a>
                                                        @endcan
                                                        @can('permanentDelete',$notification)
