                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box clearfix">
                                <h5 class="card-header m-b-20 b-0">ویرایش پرسش و پاسخ</h5>
                                @include('partial.flashMessage')
                                <form action="{{ route('faq.update',$faq) }}" method="POST" role="form" class="form-horizontal">
                                    {{ csrf_field() }}
                                    {{ method_field('PATCH') }}
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12 col-xs-12">
                                            <div class="form-group {{ $errors->has('question') ? ' has-error' : '' }}">
                                                ...
                                                <textarea name="question" class="use-rich-editor" id="question" maxlength="250" rows="6" data-placeholder="پرسش..." required>{!! $faq->question !!}</textarea>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-sm-12 col-xs-12">
                                            <div class="form-group {{ $errors->has('answer') ? ' has-error' : '' }}">
                                                ...
                                                <textarea name="answer" class="use-rich-editor" id="answer" maxlength="250" rows="6" data-placeholder="پاسخ..." required>{!! $faq->answer !!}</textarea>
                                            </div>
