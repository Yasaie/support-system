...
@section('title','- ایجاد دپارتمان جدید')
@section('description','ایجاد دپارتمان جدید')
@section('keywords','ایجاد دپارتمان جدید')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box clearfix">
                                <h5 class="card-header m-b-20 b-0">افزودن دپارتمان جدید</h5>
                                ...
                                <form action="{{ route('department.store') }}" method="POST" role="form" class="form-horizontal">
                                    ...
                                    <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }} row">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="name" class="form-control" id="name" value="{{ old('name') }}" placeholder="عنوان یا نام دپارتمان" type="text" autofocus>
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group {{ $errors->has('leaders') ? ' has-error' : '' }} row">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="leaders" class="form-control" name="leaders[]" data-placeholder="سرپرست" multiple="multiple"></select>
                                    ...
                                    <div class="form-group {{ $errors->has('managers') ? ' has-error' : '' }} row">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="managers" class="form-control" name="managers[]" data-placeholder="پشتیبان" multiple="multiple"></select>
                                    ...
                                    <div class="form-group {{ $errors->has('hidden') ? ' has-error' : '' }} row">
                                        ...
                                        <div class="col-sm-10">
                                            <input value="1" name="hidden" type="checkbox" id="hidden" {{ (old('hidden')) ? ' checked ' : '' }} data-plugin="switchery" data-color="#1AB394" data-size="small" data-secondary-color="#ED5565"/>
                                    ...
                                    <button class="btn btn-success w-lg btn-custom btm-sm waves-effect waves-light btn-xs-block pull-left" type="submit">ایجاد دپارتمان</button>
                                </form>
                            </div>
                        </div>
                    </div>
