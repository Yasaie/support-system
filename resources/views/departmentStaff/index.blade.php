                                        ...
                                        <tbody>
                                            @foreach($staffs as $staff)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#">
                                                            <span>{{ $staff->replyTickets()->count() }}</span>
                                                            <span>پاسخ به</span>
                                                            <span>{{ $staff->repliedTicketsCount() }}</span>
                                                            <span>تیکت</span>
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td>
                                                    @can('staffDelete',$staff)
                                                        <form action="{{ route('staff.destroy',$staff) }}" method="POST">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE') }}
                                                    @endcan
                                                    @can('staffUpdate',$staff)
                                                            <a class="btn btn-sm btn-primary" href="{{ route('staff.edit',$staff) }}">
                                                                <i class="ti-pencil"></i>
                                                            </a>
                                                    @endcan
                                                    @can('staffDelete',$staff)
                                                            <button class="btn btn-sm btn-danger deleteStaff" type="submit">
                                                                <i class="ti-trash"></i>
                                                            </button>
                                                        </form>
                                                    </td>
