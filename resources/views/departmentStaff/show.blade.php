                                ...
                                <form method="POST" class="form-horizontal" action="{{ route('staff.update',$staff) }}" role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                                                ...
                                                <input name="password" type="text" id="password" class="form-control" placeholder="پسوورد">
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="password_confirmation" type="text" id="password_confirmation" class="form-control" placeholder="تکرار پسوورد">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                         <div class="form-group {{ $errors->has('admin') ? ' has-error' : '' }} row">
                                            ...
                                            <div class="col-sm-10">
                                                <input value="1" name="admin" type="checkbox" id="admin" {{ ($staff->admin()) ? ' checked ' : '' }} data-plugin="switchery" data-color="#1AB394" data-size="small" data-secondary-color="#ED5565"/>
                                                @if ($errors->has('admin'))
                                                    <span class="help-block text-danger">
