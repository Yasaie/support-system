...
@section('description','ایجاد کاربر جدید')
@section('keywords','ایجاد کاربر جدید')
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h5 class="card-header m-b-20 b-0">افزودن کاربر جدید</h5>
                                @include('partial.flashMessage')
                                <form method="POST" class="form-horizontal" action="{{ route('user.store') }}" role="form">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="radio radio-success form-check-inline">
                                                    <input name="gender" id="gender-male" value="male" checked="checked" type="radio">
                                                    <label for="gender-male"> مرد </label>
                                                </div>
                                                <div class="radio radio-danger form-check-inline">
                                                    <input name="gender" id="gender-female" value="female" type="radio">
                                    ...
                                    <div class="col-sm-12">
                                         ...
                                         <div class="form-group {{ $errors->has('locked') ? ' has-error' : '' }} row">
                                            <label class="col-sm-2 col-form-label" for="locked" data-toggle="tooltip" title="فعال/غیر فعال بودن حساب کاربری">فعال باشد؟</label>
                                            <div class="col-sm-10">
                                                <input value="1" name="locked" type="checkbox" id="locked" {{ (old('locked')) ? '' : ' checked ' }} data-plugin="switchery" data-color="#1AB394" data-size="small" data-secondary-color="#ED5565"/>
                                        ...
                                        @if(Auth::user()->owner())
                                         <div class="form-group {{ $errors->has('admin') ? ' has-error' : '' }} row">
                                            ...
                                            <div class="col-sm-10">
                                                <input value="1" name="admin" type="checkbox" id="admin" {{ (old('admin')) ? ' checked ' : '' }} data-plugin="switchery" data-color="#1AB394" data-size="small" data-secondary-color="#ED5565"/>
                                                @if ($errors->has('admin'))
                                                    <span class="help-block text-danger">
