...
@section('title','- لیست نوع کاربری')
@section('description','لیست نوع کاربری')
@section('keywords','لیست نوع کاربری')
                            ...
                            <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3">
                                        <form action="{{ route('role.index') }}" role="form">
                                    ...
                                    <div class="col-xs-12 col-sm-3">
                                        ...
                                        <a class="btn btn-sm btn-primary btn-xs-block m-b-10" href="{{ route('role.create') }}">افزودن</a>
                                        @endcan
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach($roles as $role)
                                                <tr>
                                                    <td>{{ $loop->index+1 }}</td>
                                                    <td>{{ $role->name }}</td>
                                                    <td>{{ Date::make($role->created_at)->toJalali()->format('Y/m/d') }}</td>
                                                    <td>
                                                        @can('delete',$role)
                                                        ...
                                                        @endcan
                                                        @can('update',$role)
                                                            <a class="btn btn-sm btn-primary" href="{{ route('role.edit',$role) }}">
                                                                <i class="ti-pencil"></i>
                                                            </a>
                                                        @endcan
                                                        @can('delete',$role)
