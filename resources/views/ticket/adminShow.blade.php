                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <ol class="breadcrumb float-right">
                                    ...
                                    <li class="breadcrumb-item"><a title="صفحه اول پیشخوان" href="{{ route('panel')  }}">پیشخوان</a></li>
                                </ol>
                                    ...
                                    <div class="portlet">
                                        <div class="portlet-heading">
                                            ...
                                            <div class="pull-left m-t-15">
                                                @can('departmentUpdate',$ticket)
                                                <button class="btn btn-sm btn-outline-primary waves-effect waves-light m-r-5 m-b-10 btn-xs-block" data-toggle="modal" data-target="#changeDepartmentModal">
                                                    <i class="fa fa-cogs"></i>
                                                    <span>تعویض دپارتمان تیکت</span>
                                                </button>
                                                @endcan
                                                @can('close',$ticket)
                                ...
                                <div class="col-12">
                                    <div class="portlet">
                                        ...
                                        <div class="portlet-body clearfix" id="addReply">
                                            ...
                                            <!--Change Department Start-->
                                            @include('layouts.changeDepartmentModal')
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            $('.changeDepartment').click(function () {
                ...
                $.ajax({
                    url: '{{ route('ticket.department.update',$ticket) }}',
                    data: {
                    ...
                    complete: function(){
                        btn.toggleClass('btn-success btn-secondary');
                        btn.html('تعویض دپارتمان');
                        btn.removeAttr('disabled');
                    },
                    success: function () {
                        $.Notification.autoHideNotify('success', 'top left', 'انجام شد', 'تعویض دپارتمان با موفقیت انجام شد');
                    },
                    error: function () {
                        $.Notification.autoHideNotify('error', 'top left', 'انجام نشد', 'در تعویض دپارتمان مشکلی بوجود آمده است');
                    }
                });
            });
