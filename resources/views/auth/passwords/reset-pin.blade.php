...
@section('content')
    ...
    <div class="wrapper-page card-box">
        ...
        <form class="form-horizontal m-t-20" method="POST" action="{{ route('password.reset.pin') }}">
            {{ csrf_field() }}
            <div class="form-group {{ $errors->has('mobile') ? ' has-error' : '' }} row">
                <div class="col-12">
                    <div class="input-group">
                        <input name="mobile" value="{{ $mobile or old('mobile') }}" class="form-control" type="text" placeholder="شماره همراه" required>
            ...
            <div class="form-group {{ $errors->has('pin') ? ' has-error' : '' }} row">
                <div class="col-12">
                    <div class="input-group">
                        <input name="pin" class="form-control" type="text" placeholder="کلمه عبور یکبار مصرف" required autofocus>
                        <div class="input-group-append">
