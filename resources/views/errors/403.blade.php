...
@section('title','- دسترسی شما به این قسمت مجاز نیست')
@section('description','دسترسی شما به این قسمت مجاز نیست')
@section('keywords','دسترسی شما به این قسمت مجاز نیست')
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="message-box">
                        ...
                        <h5>مجوز لازم برای دسترسی به این قسمت را ندارید!</h5>
