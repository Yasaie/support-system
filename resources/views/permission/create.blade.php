...
@section('title','- ثبت سطح دسترسی جدید')
@section('description','ثبت سطح دسترسی جدید')
@section('keywords','ثبت سطح دسترسی جدید')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box clearfix">
                                <h5 class="card-header m-b-20 b-0">افزودن سطح دسترسی</h5>
                                @include('partial.flashMessage')
                                <form action="{{ route('permission.store') }}" method="POST" role="form" class="form-horizontal">
                                    {{ csrf_field() }}
                                    <div class="row">
