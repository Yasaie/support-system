...
@section('title','- ثبت کشور جدید')
@section('description','ثبت کشور جدید')
@section('keywords','ثبت کشور جدید')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box clearfix">
                                ...
                                <form action="{{ route('country.store') }}" method="POST" role="form" class="form-horizontal">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-12 col-xs-12">
                                            <div class="form-group {{ $errors->has('short_name') ? ' has-error' : '' }}">
                                                ...
                                                <input id="short_name" type="text" class="form-control" name="short_name" value="{{ old('short_name') }}" autofocus>
                                            </div>
