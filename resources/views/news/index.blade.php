...
@section('description','لیست اخبار')
@section('keywords','لیست اخبار')
                            ...
                            <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3">
                                        <form action="{{ route('news.index') }}" role="form">
                                            <div class="form-group">
                                                <input type="text" name="" id="" placeholder="جستجو..." class="custom-search-field">
                                                <i class="fa fa-search" onclick="this.parentNode.parentNode.submit()"></i>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="col-xs-12 col-sm-3">
                                        <a class="btn btn-sm btn-primary btn-xs-block m-b-10" href="{{ route('news.create') }}">افزودن</a>
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach($news as $new)
                                                <tr>
                                                    ...
                                                    <td>{{ Date::make($new->created_at)->toJalali()->format('Y/m/d') }}</td>
                                                    <td>
                                                        @can('delete',$new)
                                                        ...
                                                        @endcan
                                                        @can('update',$new)
                                                            <a class="btn btn-sm btn-primary" href="{{ route('news.edit',$new) }}">
                                                                <i class="ti-pencil"></i>
                                                            </a>
                                                        @endcan
                                                        @can('delete',$new)
