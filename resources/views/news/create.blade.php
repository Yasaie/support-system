...
@section('title','- ایجاد اخبار')
@section('description','ایجاد اخبار')
@section('keywords','ایجاد اخبار')
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h5 class="card-header m-b-20 b-0">ایجاد اطلاعیه و اخبار</h5>
                                @include('partial.flashMessage')
                                <form method="POST" class="form-horizontal" action="{{ route('news.store') }}" role="form">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-4">
                                            <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                                <label for="title">عنوان</label>
                                                <input name="title" type="text" id="title" value="{{ old('title') }}" class="form-control" placeholder="مثال: ارائه راهکار" required>
                                            </div>
                                            @if ($errors->has('title'))
                                        ...
                                        <div class="col-xs-12 col-sm-4">
                                            <div class="form-group {{ $errors->has('departments') ? ' has-error' : '' }}">
                                                ...
                                                <select name="departments[]" id="departments" class="select2 select2-multiple" multiple data-placeholder="دپارتمان"></select>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-4">
                                            <div class="form-group {{ $errors->has('published') ? ' has-error' : '' }}">
                                                ...
                                                <div class="radio radio-success form-check-inline">
                                                    <input name="published" id="published" value="1" {{ ( old('published')!=="0" ? 'checked' : null ) }} type="radio">
                                                    <label for="published"> نمایش </label>
                                                </div>
                                                <div class="radio radio-danger form-check-inline">
                                                    <input name="published" id="notPublished" value="0" {{ ( old('published')==="0" ? 'checked' : '' ) }} type="radio">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group {{ $errors->has('content') ? ' has-error' : '' }}">
                                                ...
                                                <textarea name="content" class="use-rich-editor" id="content" maxlength="250" rows="6" data-placeholder="محتوای خبر را وارد کنید...">{{ old('content') }}</textarea>
                                            </div>
